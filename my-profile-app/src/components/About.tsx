...
export default function About() {
  return (
    <section id="about" className="relative bg-[var(--color-bg)] text-[var(--color-text-primary)] min-h-screen py-24 transition-colors duration-200">
      ...
      <div className="max-w-7xl mx-auto px-8 md:px-16">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          <div>
            <p className="text-lg md:text-xl font-semibold text-[var(--color-text-heading)] mb-6 leading-relaxed">
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-4 p-6 border border-[var(--color-border)] rounded-sm hover:border-[hsl(15,90%,55%)] transition-colors">
              <div className="p-3 bg-[hsl(15,90%,55%)] rounded-sm">
                <Code2 className="w-6 h-6 text-[hsl(0,0%,8%)]" />
              </div>
              <div>
                <h3 className="text-xl font-semibold mb-2 text-[var(--color-text-primary)]">Clean Code Advocate</h3>
            ...
            <div className="flex items-start gap-4 p-6 border border-[var(--color-border)] rounded-sm hover:border-[hsl(15,90%,55%)] transition-colors">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-2 text-[var(--color-text-primary)]">Innovation Driven</h3>
                <p className="text-sm text-[var(--color-text-muted)]">
            ...
            <div className="flex items-start gap-4 p-6 border border-[var(--color-border)] rounded-sm hover:border-[hsl(15,90%,55%)] transition-colors">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-2 text-[var(--color-text-primary)]">Team Collaborator</h3>
                <p className="text-sm text-[var(--color-text-muted)]">
